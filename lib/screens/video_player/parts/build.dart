...
extension _VideoPlayerBuildMethods on VideoPlayerScreenState {
  ...
  Widget _buildVideoPlayer(BuildContext context) {
    ...
    final isLiveGuideVisible = widget.isLive && _liveTvViewMode == LiveTvViewMode.guide;
    final viewportSize = MediaQuery.sizeOf(context);
    final previewSize = LiveTvGuideLayout.previewSizeFor(viewportSize);
    final liveChannels = widget.live?.channels ?? const <LiveTvChannel>[];
    final playingChannelScopeKey = _live.channelIndex >= 0 && _live.channelIndex < liveChannels.length
        ? liveTvChannelScopeKey(liveChannels[_live.channelIndex])
        : null;
          ...
          child: Stack(
            children: [
              ...
              PositionedDirectional(
                start: isLiveGuideVisible ? null : 0,
                end: isLiveGuideVisible ? LiveTvGuideLayout.previewInset : 0,
                top: isLiveGuideVisible ? LiveTvGuideLayout.previewInset : 0,
                bottom: isLiveGuideVisible ? null : 0,
                width: isLiveGuideVisible ? previewSize.width : null,
                height: isLiveGuideVisible ? previewSize.height : null,
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    return Video(
                      key: _liveVideoSurfaceKey,
                      player: player!,
                      hasFirstFrame: _firstFrame.uiReady,
                      controls: isLiveGuideVisible
                          ? null
                          : (context) => PlexVideoControls(
                              ...
                              selectedSecondarySubtitleStreamId:
                                  _playbackSession?.subtitleSelection.secondarySourceStreamId,
              ...
              if (!isLiveGuideVisible) const VideoPlayerWatchTogetherOverlays(),
