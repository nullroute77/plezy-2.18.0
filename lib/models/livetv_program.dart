...
/// Explicit EPG status supplied by a Live TV backend.
///
/// False or absent premiere/new flags deliberately remain [unknown]. A
/// backend must positively identify a repeat before Plezy labels it a rerun.
enum LiveTvAiringStatus { unknown, newEpisode, rerun, premiere }
...
class LiveTvProgram {
  ...
  final LiveTvAiringStatus airingStatus;
  ...
  LiveTvProgram({
    ...
    this.premiere,
    this.contentRating,
    this.airingStatus = LiveTvAiringStatus.unknown,
  ...
  factory LiveTvProgram.fromJson(Map<String, dynamic> json, {Map<String, dynamic>? mediaOverride}) {
    ...
    final premiere = flexibleBool(json['premiere']);
    final airingStatus = premiere == true
        ? LiveTvAiringStatus.premiere
        : flexibleBool(json['new']) == true || flexibleBool(json['newEpisode']) == true
        ? LiveTvAiringStatus.newEpisode
        : flexibleBool(json['repeat']) == true || flexibleBool(json['rerun']) == true
        ? LiveTvAiringStatus.rerun
        : LiveTvAiringStatus.unknown;
    final originalAirDateRaw = json['originallyAvailableAt']?.toString();
    ...
    return LiveTvProgram(
      ...
      originalAirDate: originalAirDateRaw == null ? null : DateTime.tryParse(originalAirDateRaw),
